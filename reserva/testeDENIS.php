...
<body style="background-image:url(https://img.freepik.com/free-vector/modern-city-night-skyline-neon-cartoon_1441-3160.jpg?size=626&ext=jpg); background-size: 100%; background-attachment: scroll; background-repeat: no-repeat; overflow-x: hidden; overflow-y: hidden;"
>
...
<div class="col-md-6 tela1">
  ...
  <center>
    <br>
  <div class="col-md-12" style="border: 3px black solid; border-radius: 10px; margin-left: 30px; background-color: white; height: 750px;">
    ...
    <div class="col-md-12" style="border: 3px black solid; border-radius: 5px; background-color: lightgrey; overflow-y: scroll !important; overflow-x: hidden; height: 450px;">
      <br>
...
<div class="col-md-6 tela2">

  <center>

    <br>

  <form class="px-4 py-3" method="post" action="php/valida.php" style="width: 450px; background-color: white; border: 3px black solid; border-radius: 3px; margin-top: 200px;">
